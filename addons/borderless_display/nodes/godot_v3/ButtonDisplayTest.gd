...
func _ready() -> void:
	...
	WINDOW_SIZE.clear()
	WINDOW_SIZE.append(Vector2( 480,  320)) # id  0
	WINDOW_SIZE.append(Vector2( 640,  480)) # id  1
	WINDOW_SIZE.append(Vector2( 768,  480)) # id  2
	WINDOW_SIZE.append(Vector2( 800,  600)) # id  3
	WINDOW_SIZE.append(Vector2( 960,  640)) # id  4
	WINDOW_SIZE.append(Vector2(1280,  720)) # id  5
	WINDOW_SIZE.append(Vector2(1920, 1080)) # id  6
	WINDOW_SIZE.append(Vector2( 512,  512)) # id  7
	WINDOW_SIZE.append(Vector2( 320,  480)) # id  8
	WINDOW_SIZE.append(Vector2( 480,  640)) # id  9
	WINDOW_SIZE.append(Vector2( 480,  768)) # id 10
	WINDOW_SIZE.append(Vector2( 600,  800)) # id 11
	WINDOW_SIZE.append(Vector2( 640,  960)) # id 12
	WINDOW_SIZE.append(Vector2( 720, 1280)) # id 13
	WINDOW_SIZE.append(Vector2(1080, 1920)) # id 14
	WINDOW_SIZE.append(Vector2( 256,  224)) # id 15
	WINDOW_SIZE.append(Vector2( 256,  240)) # id 16

	popup.connect("id_pressed", self, "_on_button_pressed")
